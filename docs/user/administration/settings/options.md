...
This integration has been part of BuddyPress’ Activity component since BuddyPress 1.7 — see the [Codex for background on the Akismet integration](https://codex.buddypress.org/releases/version-1-7/akismet/).
